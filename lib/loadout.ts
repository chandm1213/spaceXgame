...
export const SKINS: Skin[] = [
  ...
  { id: 2, name: 'VOID', tag: 'STEALTH COATING', hull: '#1e1b2e', nose: '#000000', accent: '#a855f7' },
  { id: 3, name: 'TOXIC', tag: 'BIO-HAZARD HULL', hull: '#3f6212', nose: '#0a1402', accent: '#a3e635' },
  { id: 4, name: 'SOLAR', tag: 'GILDED CHASSIS', hull: '#d4a017', nose: '#3b2606', accent: '#fde047' },
];
...
export const WEAPONS: Weapon[] = [
  ...
  { id: 3, name: 'RAILGUN', tag: 'PIERCING', color: '#f472b6', cooldown: 0.5, damage: 4, bolts: 1, spread: 0, speed: 80, radius: 1.6, pierce: 3 },
];
